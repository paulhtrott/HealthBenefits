<%-- 
    Document   : listoffoods - displays a list of search for foods based on search parameters.
    Created on : Feb 27, 2013, 4:38:05 PM
    Author     : Paul Trott (ptrott)
--%>
<%--tag library included for --%>
...
<html>
    <head>
        ...
        <title>List of Foods - Health Benefits of Foods</title>
