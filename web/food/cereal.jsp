<%-- 
    Document   : cereal jsp page to display cereal foods.
    Created on : Feb 23, 2013, 2:25:17 PM
...
<html lang="en-US">
    <head>
        <meta charset="utf-8">
        <title>Cereal - Health Benefits of Foods</title>
                ...
                <ul class="hmenu">
                    ...
                    <li><a href="#">Grains</a>
                        <ul>
                            ...
                            <li><a href="foods?foodType=cereal" class="active">Cereal</a></li>
                                            ...
                                            <div class="content-layout layout-item-1">
                                                <div class="content-layout-row">
                                                    <div class="layout-cell layout-item-3 " style="width: 100%" >
                                                        <h1>Crunchy&mdash;Munchy Cereals</h1>
                                                        <ul>
                                                            <%--Code to get foodInfo to display cereal--%>
