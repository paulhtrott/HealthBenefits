<%-- 
    Document   : pasta jsp page to display pasta foods
    Created on : Feb 23, 2013, 2:34:15 PM
...
<html lang="en-US">
    <head>
        <meta charset="utf-8">
        <title>Pasta - Health Benefits of Foods</title>
                ...
                <ul class="hmenu">
                    ...
                    <li><a href="#">Grains</a>
                        <ul>
                            ...
                            <li><a href="foods?foodType=pasta" class="active">Pasta</a></li>
                        </ul>
                    </li>
