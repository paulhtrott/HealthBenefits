<%-- 
    Document   : legumes jsp page to display legume foods
    Created on : Feb 23, 2013, 2:42:25 PM
...
<html lang="en-US">
    <head>
        <meta charset="utf-8">
        <title>Legumes - Health Benefits of Foods</title>
        ...
        <div id="main">
            <nav class="nav clearfix">
                <ul class="hmenu">
                    ...
                    <li><a href="foods?foodType=legumes" class="active">Legumes</a></li>
                                            ...
                                            <div class="content-layout layout-item-1">
                                                <div class="content-layout-row">
                                                    <div class="layout-cell layout-item-3 " style="width: 100%" >
                                                        <h1>Beautiful Legumes</h1>
                                                        <ul>
                                                            <%--Code to get foodInfo to display legume foods on page--%>
