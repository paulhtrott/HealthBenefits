<%-- 
    Document   : dairy jsp page to display dairy foods.
    Created on : Feb 23, 2013, 2:37:57 PM
...
<html lang="en-US">
    <head>
        <meta charset="utf-8">
        <title>Dairy - Health Benefits of Foods</title>
        ...
        <div id="main">
            <nav class="nav clearfix">
                <ul class="hmenu">
                    ...
                    <li><a href="foods?foodType=dairy" class="active">Dairy</a></li>
                                            ...
                                            <div class="content-layout layout-item-1">
                                                <div class="content-layout-row">
                                                    <div class="layout-cell layout-item-3 " style="width: 100%" >
                                                        ...
                                                        <ul>
                                                            <%--Code to get foodInfo to display dairy foods on page--%>
