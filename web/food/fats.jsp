<%-- 
    Document   : fats jsp page to display fat foods
    Created on : Feb 23, 2013, 3:24:34 PM
...
<html lang="en-US">
    <head>
        <meta charset="utf-8">
        <title>Fats - Health Benefits of Foods</title>
        ...
        <div id="main">
            <nav class="nav clearfix">
                <ul class="hmenu">
                    ...
                    <li><a href="foods?foodType=fats" class="active">Fats</a></li>
