<%-- 
    Document   : redmeat jsp page to display redmeat foods.
...
<html lang="en-US">
    <head>
        <meta charset="utf-8">
        <title>Red Meat - Health Benefits of Foods</title>
                ...
                <ul class="hmenu">
                    ...
                    <li><a href="#">Meats</a>
                        <ul>
                            ...
                            <li><a href="foods?foodType=redmeat" class="active">Red Meat</a></li>
                        </ul>
                    </li>
                    <li><a href="#">Grains</a>
                        <ul>
                                                ...
                                                <div class="content-layout layout-item-1">
                                                    <div class="content-layout-row">
                                                        <div class="layout-cell layout-item-3 " style="width: 100%" >
                                                            <h1>Delightful Red Meat Choices</h1>
                                                            <ul>
