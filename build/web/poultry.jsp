<%-- 
    Document   : poultry jsp page to display poultry information
    Created on : Feb 23, 2013, 2:03:09 PM
...
<html lang="en-US">
    <head>
        <meta charset="utf-8">
        <title>Poultry - Health Benefits of Foods</title>
        ...
        <div id="main">
            <nav class="nav clearfix">
                <ul class="hmenu">
                    ...
                    <li><a href="#">Meats</a>
                        <ul>
                            <li><a href="foods?foodType=poultry" class="active">Poultry</a></li>
                                                ...
                                                <div class="content-layout layout-item-1">
                                                    <div class="content-layout-row">
                                                        <div class="layout-cell layout-item-3 " style="width: 100%" >
                                                            <h1>Nutritious Poultry Choices</h1>
                                                            <ul>
