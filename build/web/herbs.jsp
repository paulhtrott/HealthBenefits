<%-- 
    Document   : herbs jsp page to display herbs
    Created on : Feb 23, 2013, 3:28:40 PM
...
<html lang="en-US">
    <head>
        <meta charset="utf-8">
        <title>Herbs - Health Benefits of Foods</title>
        ...
        <div id="main">
            <nav class="nav clearfix">
                <ul class="hmenu">
                    ...
                    <li><a href="foods?foodType=herbs" class="active">Herbs</a></li>
                </ul> 
            </nav>
