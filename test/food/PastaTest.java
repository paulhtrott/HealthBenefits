...
/**
 * Test of all methods of the Pasta Class.
 * 
...
public class PastaTest {
    ...
    /**
     * Default no-arg constructor for Pasta class.
     */
    @Test
    public void testPasta(){
        System.out.println("Default Constructor");
        Food instance = new Pasta();
    ...
    /**
     * Test overloaded constructor for Pasta class.
     */
    @Test
    public void testOverloadedPasta(){
        System.out.println("Overloaded Constructor");
        Food instance = new Pasta("Macaroni", 235, 112, 1.5, 13.4, 12.54, 23.22);
        
        //Test name value.
        String expResult = "Macaroni";
        String result = instance.getName();
        assertEquals(expResult, result);
    ...
    public void testGetName() {
        ...
        for(int i = 0; i < 3; i++){
            ...
            switch(randNum){
                case 1 :
                        instance.setName("Spagetti");
                        expResult = "Spagetti";
                break;
                case 2 : 
                        instance.setName("Macaroni");
                        expResult = "Macaroni";
                break;
                case 3 : 
                        instance.setName("Rotini");
                        expResult = "Rotini";
                break;
                case 4 : 
                        instance.setName("Pellizzoni");
                        expResult = "Pellizzoni";
                break;
                default :
                        instance.setName("Capellini");
                        expResult = "Capellini";
                break;
            }
        }
