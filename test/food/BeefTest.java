...
/**
 * Test of all methods of the Beef Class.
 * 
...
public class BeefTest {
    ...
    /**
     * Default no-arg constructor for Beef class.
     */
    @Test
    public void testBeef(){
        System.out.println("Default Constructor");
        Food instance = new Beef();
    ...
    /**
     * Test overloaded constructor for Beef class.
     */
    @Test
    public void testOverloadedBeef(){
        System.out.println("Overloaded Constructor");
        Food instance = new Beef("Steak", 235, 112, 1.5, 13.4, 12.54, 23.22);
        
        //Test name value.
        String expResult = "Steak";
        String result = instance.getName();
        assertEquals(expResult, result);
    ...
    /**
     * Test of getName method, of class Beef.
     */
    @Test
    public void testGetName() {
        ...
        for(int i = 0; i < 3; i++){
            ...
            switch(randNum){
                case 1 :
                        instance.setName("Steak");
                        expResult = "Steak";
                break;
                case 2 : 
                        instance.setName("T-Bone");
                        expResult = "T-Bone";
                break;
                case 3 : 
                        instance.setName("Ground");
                        expResult = "Ground";
                break;
                case 4 : 
                        instance.setName("Chunk");
                        expResult = "Chunk";
                break;
                default :
                        instance.setName("Chop");
                        expResult = "Chop";
                break;
            }
        }
    ...
    /**
     * Test of setName method, of class Beef.
     */
    @Test
