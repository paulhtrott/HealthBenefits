...
/**
 * Test for the Fish Class methods.
...
public class FishTest {
    ...
    /**
     * Default no-arg constructor for Fish class.
     */
    @Test
    public void testFish(){
        System.out.println("Default Constructor");
        Food instance = new Fish();
    ...
    /**
     * Test overloaded constructor for Fish class.
     */
    @Test
    public void testOverloadedFish(){
        System.out.println("Overloaded Constructor");
        Food instance = new Fish("Wahoo", 235, 112, 1.5, 13.4, 12.54, 23.22);
        
        //Test name value.
        String expResult = "Wahoo";
        String result = instance.getName();
        assertEquals(expResult, result);
    ...
    public void testGetName() {
        ...
        for(int i = 0; i < 3; i++){
            ...
            switch(randNum){
                case 1 :
                        instance.setName("Tuna");
                        expResult = "Tuna";
                break;
                case 2 : 
                        instance.setName("Walleye");
                        expResult = "Walleye";
                break;
                case 3 : 
                        instance.setName("Sail Fish");
                        expResult = "Sail Fish";
                break;
                case 4 : 
                        instance.setName("Marlin");
                        expResult = "Marlin";
                break;
                default :
                        instance.setName("Trigger fish");
                        expResult = "Tigger fish";
                break;
            }
        }
