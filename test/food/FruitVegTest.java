...
/**
 * Test for the FruitVeg Class methods.
...
public class FruitVegTest {
    ...
    /**
     * Default no-arg constructor for FruitVeg class.
     */
    @Test
    public void testFruitVeg(){
        System.out.println("Default Constructor");
        Food instance = new FruitVeg();
    ...
    /**
     * Test overloaded constructor for FruitVeg class.
     */
    @Test
    public void testOverloadedFruitVeg(){
        System.out.println("Overloaded Constructor");
        Food instance = new FruitVeg("Tomato", 235, 112, 1.5, 13.4, 12.54, 23.22);
    ...
    public void testGetName() {
        ...
        for(int i = 0; i < 3; i++){
            ...
            switch(randNum){
                case 1 :
                        instance.setName("Caigua");
                        expResult = "Caigua";
                break;
                case 2 : 
                        instance.setName("Calabash");
                        expResult = "Calabash";
                break;
                case 3 : 
                        instance.setName("Calabaza");
                        expResult = "Calabaza";
                break;
                case 4 : 
                        instance.setName("Chayote");
                        expResult = "Chayote";
                break;
                default :
                        instance.setName("Coccinia grandis");
                        expResult = "Coccinia grandis";
                break;
            }
        }
