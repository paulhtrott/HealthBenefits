...
/**
 * Test of all methods of the Bread Class.
 * 
...
public class BreadTest {
    ...
    /**
     * Default no-arg constructor for Bread class.
     */
    @Test
    public void testBread(){
        System.out.println("Default Constructor");
        Food instance = new Bread();
    ...
    /**
     * Test overloaded constructor for Bread class.
     */
    @Test
    public void testOverloadedBread(){
        System.out.println("Overloaded Constructor");
        Food instance = new Bread("White", 235, 112, 1.5, 13.4, 12.54, 23.22);
    ...
    public void testGetName() {
        ...
        for(int i = 0; i < 3; i++){
            ...
            switch(randNum){
                case 1 :
                        instance.setName("White");
                        expResult = "White";
                break;
                case 2 : 
                        instance.setName("Wheat");
                        expResult = "Wheat";
                break;
                case 3 : 
                        instance.setName("Rye");
                        expResult = "Rye";
                break;
                case 4 : 
                        instance.setName("Multi-Grain");
                        expResult = "Multi-Grain";
                break;
                default :
                        instance.setName("Roll");
                        expResult = "Roll";
                break;
            }
        }
