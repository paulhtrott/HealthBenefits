...
public class VegetableTest {
    ...
    /**
     * Test overloaded constructor for Vegetable class.
     */
    @Test
    public void testOverloadedVegetable(){
        System.out.println("Overloaded Constructor");
        Food instance = new Fruit("Carrot", 235, 112, 1.5, 13.4, 12.54, 23.22);
    ...
    public void testGetName() {
        ...
        for(int i = 0; i < 3; i++){
            ...
            switch(randNum){
                ...
                break;
                case 2 : 
                        instance.setName("Celery");
                        expResult = "Celery";
                break;
                case 3 : 
                        instance.setName("Cabbage");
                        expResult = "Cabbage";
                break;
                case 4 : 
                        instance.setName("Lettuce");
                        expResult = "Lettuce";
                break;
                default :
                        instance.setName("Beets");
                        expResult = "Beets";
                break;
            }
        }
