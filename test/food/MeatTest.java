...
/**
 * Test for the Meat Class methods.
...
public class MeatTest {
    ...
    /**
     * Default no-arg constructor for Meat class.
     */
    @Test
    public void testMeat(){
        System.out.println("Default Constructor");
        Food instance = new Meat();
    ...
    /**
     * Test overloaded constructor for Meat class.
     */
    @Test
    public void testOverloadedMeat(){
        System.out.println("Overloaded Constructor");
        Food instance = new Meat("Tomato", 235, 112, 1.5, 13.4, 12.54, 23.22);
    ...
    public void testSetName() {
        ...
        for(int i = 0; i < 6; i++){
            ...
            switch(randNum){
                case 1 :
                        instance.setName("Beef");
                        expResult = "Beef";
                break;
                case 2 : 
                        instance.setName("Goat");
                        expResult = "Goat";
                break;
                case 3 : 
                        instance.setName("Lamb");
                        expResult = "Lamb";
                break;
                case 4 : 
                        instance.setName("Poultry");
                        expResult = "Poultry";
                break;
                default :
